...
import (
	...
	customtx "github.com/onchainengineer/visca/app/tx"
	...
	viscaappparams "github.com/onchainengineer/visca/app/params"
...
var (
	_ servertypes.Application = (*ViscaApp)(nil)
)
...
// ViscaApp extends an ABCI application, but with most of its parameters exported.
...
// NewViscaApp returns a reference to an initialized Visca.
func NewViscaApp(
	logger log.Logger,
	db dbm.DB,
	...
	homePath string,
	invCheckPeriod uint,
	encodingConfig viscaappparams.EncodingConfig,
...
// AppCodec returns Visca's app codec.
//
// NOTE: This is solely to be used for testing purposes as it may be desirable
// for modules to register their own custom testing types.
...
// InterfaceRegistry returns Visca's InterfaceRegistry
...
func (app *ViscaApp) GetKey(storeKey string) *sdk.KVStoreKey {
...
//
// NOTE: This is solely to be used for testing purposes.
func (app *ViscaApp) GetTKey(storeKey string) *sdk.TransientStoreKey {
...
func (app *ViscaApp) GetMemKey(storeKey string) *sdk.MemoryStoreKey {
...
func (app *ViscaApp) RegisterUpgradeHandlers(cfg module.Configurator) {}
...
func (app *ViscaApp) enforceStakingForVestingTokens(ctx sdk.Context, genesisState GenesisState) {

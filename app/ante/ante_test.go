...
func createTestApp(isCheckTx bool, tempDir string) (*viscaapp.ViscaApp, sdk.Context) {
	app := viscaapp.NewViscaApp(
		log.NewNopLogger(), dbm.NewMemDB(), nil, true, map[int64]bool{},
		tempDir, simapp.FlagPeriodValue, viscaapp.MakeEncodingConfig(),
